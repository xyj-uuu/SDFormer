...
class OccHead(nn.Module):
    def __init__(
        ...
        if kitti360:
            ...
            kitti360_weight = torch.from_numpy(np.array(
                [0.464, 0.595, 0.865, 0.871, 0.717, 0.657, 0.852, 0.541, 0.602, 0.567, 0.607, 0.540, 0.636, 0.513,
                 0.564, 0.701, 0.774, 0.580, 0.690]))
