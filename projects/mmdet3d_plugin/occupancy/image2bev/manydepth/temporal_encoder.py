...
import projects.mmdet3d_plugin.occupancy.image2bev.manydepth.networks
from torch.autograd import Variable
from .networks.resnet_encoder import ResnetEncoder, ResnetEncoderMatching, transformation_from_parameters
