...
from .segment_anything.build_sam import image_encoder_registry
...
class SAMEncoder(nn.Module):
    def __init__(self, encoder_checkpoint="/data/B221000559-XYJ/project/SGN/pretrain/sam_vit_b_01ec64.pth", model_type='vit_b', im_size=1024, is_optimize=False):
        super().__init__()
    ...
    def preprocess(self, x: torch.Tensor, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
